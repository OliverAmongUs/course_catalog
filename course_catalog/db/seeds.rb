...
Course.import columns_course, courseArray validate: false
Subject.import columns_subject, subjectArray validate: false
Instructor.import columns_instructor, instructorArray validate: false
